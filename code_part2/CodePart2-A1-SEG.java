...
public class CollectionExecutingTime{
    ...
    public static void main(String[] args){
        ...
        final int size = 1000000; //NOT SURE IF THIS IS THE RIGHT SIZE BUT CHANGE IT IF U HAVE TO RAIYAN !!!!!!!!!
        ...
        getTotalListOfArray(listOfArray);
        ...
        long thirdTimeSec = TimeUnit.NANOSECONDS.toSeconds(thirdTimeSec);
